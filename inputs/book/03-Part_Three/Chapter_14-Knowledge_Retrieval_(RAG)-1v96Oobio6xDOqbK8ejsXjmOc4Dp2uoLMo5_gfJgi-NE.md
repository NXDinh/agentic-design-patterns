...
![RAG Core Concept: Chunking, Embeddings, and Vector Database](../../../assets/book/RAG_Core_Concepts_Chunking_Embeddings_and_Vector_Database.png)
...
![Agentic RAG Introduces Reasoning Agent](../../../assets/book/Agentic_RAG_Introduces_Reasoning_Agent.png)
...
![Knowledge Retrieval Pattern Database](../../../assets/book/Knowledge_Retrieval_Pattern_Database.png)

Knowledge Retrieval pattern: an AI agent to query and retrieve information from structured databases

![Knowledge Retrieval Pattern Search](../../../assets/book/Knowledge_Retrieval_Pattern_Search.png)
