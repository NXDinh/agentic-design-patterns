...
![GCP: Access AgentSpace](../../../assets/book/GCP_Access_AgentSpace.png)
...
![GCP: Integrate with diverse services](../../../assets/book/GCP_Integrate_with_diverse_services.png)
...
![GCP: Googles Gallery of Pre-Assembled Prompts](../../../assets/book/GCP_Googles_Gallery_of_Pre_Assembled_Prompts.png)
...
![GCP: Customizing the Agent's Prompt](../../../assets/book/GCP_Customizing_the_Agents_Prompt.png)
...
![GCP: AgentSpace Advanced Capabilities](../../../assets/book/GCP_AgentSpace_Advanced_Capabilities.png)

Fig. 5: AgentSpace advanced capabilities

Upon completion, the AgentSpace chat interface (Fig. 6\) will be accessible.

![GCP: AgentSpace User Interface for initiating a chat with your Agent](../../../assets/book/GCP_AgentSpace_User_Interface_for_initiating_a_chat_with_your_Agent.png)
